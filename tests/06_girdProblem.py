...
problem.set_initial_value(robot_at(deliverybots[1],locations[mat2lin(0,2,m)]),True)
problem.set_initial_value(is_occupied(locations[mat2lin(0,0,m)]),True)
problem.set_initial_value(is_occupied(locations[mat2lin(0,2,m)]),True)
...
#goal
problem.add_timed_goal(StartTiming(10.0), robot_at(deliverybots[0],locations[mat2lin(4,4,m)]))
problem.add_timed_goal(StartTiming(100.0), robot_at(deliverybots[1],locations[mat2lin(2,4,m)]))
