(define (domain maildelivery-domain)
 ...
 (:durative-action move
  ...
  :condition (and (at start (is_connected ?l_from ?l_to))(at start (robot_at ?r ?l_from))(at start (<= (* 2 (distance ?l_from ?l_to)) (charge ?r)))(at end (is_free ?l_to)))
  :effect (and (at start (not (robot_at ?r ?l_from))) (at start (is_free ?l_from)) (at end (robot_at ?r ?l_to)) (at end (not (is_free ?l_to)))))
 (:action pickup
